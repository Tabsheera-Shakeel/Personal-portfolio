...
const AboutPage = () => {
  return (
    <div
      id="about"
      className="relative w-screen h-screen bg-cover bg-center flex flex-col items-center justify-center p-5 overflow-hidden"
      style={{ backgroundImage: "url('/text-[rgba(0,0,0,0.54)] (1).png')" }}
    >
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-8 text-yellow-700 text-center">
        About Me
      </h2>

      <div className="flex justify-center items-center w-full max-w-screen-sm sm:max-w-screen-md px-4">
        <div
          className="relative bg-cover bg-center p-4 sm:p-5 md:p-10 rounded-lg shadow-lg text-gray-800 overflow-hidden"
          style={{
        ...
        >
          <p className="text-xs sm:text-sm md:text-base font-mono font-semibold text-black leading-relaxed">
